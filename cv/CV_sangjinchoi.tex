...
\begin{itemize}[leftmargin=11pt,label=\textbullet,itemsep=4pt,parsep=2pt]
  ...
  \item \textbf{Energy-Efficient AI Systems}
    \begin{itemize}[leftmargin=0pt,label={},labelsep=0pt,itemsep=2pt,parsep=0pt]
      ...
      \item \textbf{EnvPipe} \hfill \textit{USENIX ATC 2023} \quad \href{https://www.usenix.org/conference/atc23/presentation/choi}{[Paper]} \href{https://github.com/casys-kaist/EnvPipe}{[Code]}
        \begin{itemize}[label=--,itemsep=0pt,parsep=0pt]
  ...
  \item \textbf{GPU Memory Systems}
    \begin{itemize}[leftmargin=0pt,label={},labelsep=0pt,itemsep=2pt,parsep=0pt]
      \item \textbf{HUVM} \hfill \textit{USENIX ATC 2022} \quad \href{https://www.usenix.org/conference/atc22/presentation/choi-sangjin}{[Paper]} \href{https://github.com/casys-kaist/HUVM}{[Code]}
        \begin{itemize}[label=--,itemsep=0pt,parsep=0pt]
