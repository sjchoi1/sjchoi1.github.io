...
I build cost-efficient AI infrastructure by designing systems software around hardware capabilities and AI workload behavior.
...
\begin{enumerate}[label={[\arabic*]},leftmargin=*,labelsep=0.6em,itemsep=3pt,parsep=0pt,topsep=0pt]
  \item \textbf{[ACM ATC 2026]} \textbf{Sangjin Choi}, Sukmin Cho, Yifan Xiong, Ziyue Yang, Youngjin Kwon, and Peng Cheng. ``ELDR: Expert-Locality-Aware Decode Routing for PD-Disaggregated MoE Serving.''
...
\begin{itemize}[leftmargin=11pt,label=\textbullet,itemsep=4pt,parsep=2pt]
  \item \textbf{LLM Inference Systems}
    \begin{itemize}[leftmargin=0pt,label={},labelsep=0pt,itemsep=2pt,parsep=0pt]
      \item \textbf{ELDR} \hfill \textit{ACM ATC 2026} \quad \href{https://arxiv.org/abs/2607.00466}{[Paper]}
...
\vfill
\noindent\hfill{\small\textcolor{cvgray}{Last updated: September 2026}}
